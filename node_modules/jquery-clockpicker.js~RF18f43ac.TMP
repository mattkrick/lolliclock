...
;(function(){
	...
	ClockPicker.DEFAULTS = {
		'default': '7:00 AM',       // default time, 'now' or '13:14' e.g.
	...
	ClockPicker.prototype.show = function(e){
		...
		if (! this.isAppended) {
			...
			this.closeButtons.addClass('animate');
	        ...
	        self.closeButtons.removeClass("animate");
		...
		//Get the time
		var defValue = this.options.default === 'now' ? new Date() : new Date('1970 1 1 ' + this.options.default);
